...
(function(window, factory) {
  ...
  Tour = (function() {
    ...
    Tour.prototype._scrollIntoView = function(step, callback) {
      ...
      this._debug("Scroll into views. ScrollTop: " + scrollTop + ". Element offset: " + offsetTop + ". Window height: " + windowHeight + ".");
      counter = 0;
      return $('body, html').stop(true, true).animate({
        ...
        return function() {
          if (++counter === 2) {
            callback();
            return _this._debug("Scroll into views.\nAnimation end element offset: " + ($element.offset().top) + ".\nWindow height: " + ($window.height()) + ".");
          }
        };
      })(this));
    };
    ...
    Tour.prototype._showOverlayElement = function(step, force) {
      ...
      if (!this.backdrop.overlayElementShown) {
        ...
        this.backdrop.$main-background = $('<div>', {
          "class": 'tour-step-background'
        });
        this.backdrop.$main-background.appendTo(step.backdropContainer);
      ...
      return this.backdrop.$main-background.width(elementData.width).height(elementData.height).offset(elementData.offset);
    };
    ...
    Tour.prototype._hideOverlayElement = function() {
      ...
      this.backdrop.$main-background.remove();
      this.backdrop.$element = null;
      this.backdrop.$main-background = null;
