...
class ControllerReference
{
     ...
     * @param array  $attributes An array of parameters to add to the Requests attributes
     * @param array  $query      An array of parameters to add to the Requests query string
     */
