                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Edit mail template
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="code" name="content">{{$mail->content}}</textarea>
                                    <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control" name="type">
                                        <option value="order_to_custommer" {{ ($mail->type == 'order_to_custommer') ? 'selected' : '' }}>New Order email to Customer</option>
                                        <option value="order_to_admin" {{ ($mail->type == 'order_to_admin') ? 'selected' : '' }}>New Order email to Admin</option>
                                        <option value="instructions" {{ ($mail->type == 'instructions') ? 'selected' : '' }}>Instructions email</option>
                                        <option value="booster_to_admin" {{ ($mail->type == 'booster_to_admin') ? 'selected' : '' }}>Booster Assigned Email to Admin</option>
                                        <option value="booster_to_custommer" {{ ($mail->type == 'booster_to_custommer') ? 'selected' : '' }}>Booster Assigned Email to Customer</option>
                                        <option value="order_complete" {{ ($mail->type == 'order_complete') ? 'selected' : '' }}>Order Completed</option>
                                    </select>
                                </div>
